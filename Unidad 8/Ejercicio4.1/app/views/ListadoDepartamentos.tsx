...
const ListadoDepartamentos = observer(() => {
    ...
    const handleAdd = () => {
        router.push({ pathname: '/editar-insertar-departamento', params: { id: null } }); 
    };

    const handleEdit = (departamento: any) => {
         router.push({ pathname: '/editar-insertar-departamento', params: { id: departamento.id, nombre: departamento.nombre } });
    };
    ...
    const departamentosFiltrados = vm.departamentos.filter(d => 
